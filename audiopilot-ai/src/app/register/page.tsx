  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#06131f] px-6 text-white">
      <section className="w-full max-w-md rounded-3xl border border-[#22384d] bg-[#0d1f31] p-8">
        <h1 className="text-3xl font-bold text-[#38bdf8]">Create Account</h1>
        <p className="mt-2 text-sm text-[#8aa3b8]">Set up your AudioPilot AI workspace.</p>

        <form className="mt-8 space-y-5">
          <input className="w-full rounded-xl border border-[#22384d] bg-[#06131f] px-4 py-3 outline-none" placeholder="Full name" />
        ...
        <p className="mt-6 text-sm text-[#8aa3b8]">
          Already have an account? <Link href="/login" className="text-[#38bdf8]">Login</Link>
        </p>
      </section>
    </main>
  );
