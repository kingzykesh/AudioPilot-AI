...
export function clearAudioLogs() {
  ...
  try {
    ...
    console.error(
      "Failed to clear audio logs:",
      error
    );
  }
}

export function getLatestAudioLog():
  | AudioLogEntry
  | null {
